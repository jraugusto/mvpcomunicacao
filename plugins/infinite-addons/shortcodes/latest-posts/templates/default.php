<div class="row">
	...
	<div class="col-md-4 col-md-offset-0 col-sm-6 col-xs-12">
		...
		<div class="latest-posts latest-default latest-title-lg latest-content-extra-padding2 latest-shadow meta-caption meta-semibold meta-sm2">

			<figure>
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
					<?php if( has_post_thumbnail() ) {
							rella_the_post_thumbnail( 'rella-university-blog', null, false );
						} else{
