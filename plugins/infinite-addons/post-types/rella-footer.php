 ...
 */
$labels = array(
	'name'                  => _x( 'Footers', 'Post Type General Name', 'infinite-addons' ),
	'singular_name'         => _x( 'Footer', 'Post Type Singular Name', 'infinite-addons' ),
	'menu_name'             => __( 'Footers', 'infinite-addons' ),
	'name_admin_bar'        => __( 'Footers', 'infinite-addons' ),
	...
	'add_new_item'          => __( 'Add New Footer', 'infinite-addons' ),
	'add_new'               => __( 'Add New', 'infinite-addons' ),
	'new_item'              => __( 'New Footer', 'infinite-addons' ),
	'edit_item'             => __( 'Edit Footer', 'infinite-addons' ),
	'update_item'           => __( 'Update Footer', 'infinite-addons' ),
	'view_item'             => __( 'View Footer', 'infinite-addons' ),
	'search_items'          => __( 'Search Footer', 'infinite-addons' ),
...
$args = array(
	'label'                 => __( 'Footer', 'infinite-addons' ),
	'labels'        => $labels,
...
register_post_type( 'rella-footer', $args );
