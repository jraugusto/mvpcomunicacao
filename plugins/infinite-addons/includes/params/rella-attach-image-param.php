 ...
 */
vc_add_shortcode_param( 'rella_attach_image', 'rella_attach_images_form_field' );
function rella_attach_images_form_field( $settings, $value ) {
	...
	$output .= '<a class="gallery_widget_add_images" href="#" use-single="true" title="'
		. esc_html__( 'Add image', 'infinte-addons' ) . '"><i class="vc-composer-icon vc-c-icon-add"></i>' . esc_html__( 'Add image', 'infinite-addons' ) . '</a>'; //class: button
