window.RellaMultiPostThumbnails = {
    ...
    removeThumbnail: function(id, post_type, nonce){
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    RellaMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    },
    ...
    setAsThumbnail: function(thumb_id, id, post_type, nonce){
	    ...
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    win.RellaMultiPostThumbnails.setThumbnailID(thumb_id, id, post_type);
			    win.RellaMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    }
